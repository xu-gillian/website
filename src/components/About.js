        ...
        <div className="about-container" id="about">
            ...
            <div className="profile-container">
                ...
                <div className="profile-text">
                    ...
                    <p className="removeSpacing">In my free time, I enjoy playing frisbee, playing the piano, and spending time with friends. I would like to spend this year developing more side projects, which includes trying to create my own game!</p>
